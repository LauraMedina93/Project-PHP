...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            'kernel.root_dir' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev',
            'kernel.logs_dir' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/logs',
            'kernel.bundles' => array(
                ...
                'cineBundle' => 'Info\\cineBundle\\cineBundle',
                'getBundle' => 'Info\\getMoviesBundle\\getBundle',
                'postBundle' => 'Info\\postMoviesBundle\\postBundle',
            ...
            'locale' => 'en',
            'secret' => '0d3a5d904a173fb824fe83bfaf1fdc13bfa341e7',
            ...
            'kernel.secret' => '0d3a5d904a173fb824fe83bfaf1fdc13bfa341e7',
            ...
            'session.save_path' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/assetic/routing.yml',
            ...
            'debug.container.dump' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/../web',
            'assetic.write_to' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/doctrine/orm/Proxies',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Cinemateka', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a2771107ef380535a73c1d76f780863b8041a88a94f65ca6f38f9d1821d53604');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/login$'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/admin/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/admin/logout'));
        ...
        $k->setOptions(array('login_path' => '/admin/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Info\\cineBundle/Resources/views'), 'cine');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Info\\getMoviesBundle/Resources/views'), 'get');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\Info\\postMoviesBundle/Resources/views'), 'post');
        ...
        $instance->addPath('C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/Resources/views');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0d3a5d904a173fb824fe83bfaf1fdc13bfa341e7');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/Project-PHP/Cinemateka/finalProject/app/cache/dev');
    }
